...
@endif
		...
		<h4 class="subheadline">Login</h4>
		<div class="clear"></div>

		<form method="post" action="/auth/login" id="update_profile_form">
			...
			<div class="well">
				...
				<input type="text" class="form-control" name="password" id="username" required="required" style="cursor: auto; background-image: url(&quot;data:image/png;base64,&quot;); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
			</div>
