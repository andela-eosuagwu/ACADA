<html class="gr__devdojo_com"><head>
    ...
    <meta name="description" content="Welcome to the ACADA">
    ...
    <link rel="stylesheet" type="text/css" href="{! secure_asset('/res/stylesheet/style1.css') !}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/res/stylesheet/style1.css') }}">
    
    <link rel="stylesheet" type="text/css" href="{! secure_asset('/res/stylesheet/style2.css') !}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/res/stylesheet/style2.css') }}">
    
    <link rel="stylesheet" type="text/css" href="{! secure_asset('/res/stylesheet/style3.css') !}">
    ...
    <body class="home" ginger_software_stylesheet="true" ginger_software_doc="true">
        ...
        @include('app.includes.contents.index_content')
