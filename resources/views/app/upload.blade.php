...
<div class="container user">
		...
		<form method="post" action="/video/create" id="update_profile_form">
			...
			<div class="well">
				...
				<input type="text" class="form-control" name="src" id="username" value="emeka" style="cursor: auto; background-image: url(&quot;data:image/png;base64,&quot;); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
			</div>

			<div class="well">
				<label for="username">Video Title</label>
				<input type="text" class="form-control" name="title" id="username" value="emeka" style="cursor: auto; background-image: url(&quot;data:image/png;base64,&quot;); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
			</div>

			<div class="well">
				<label for="email">Category</label>
				<input type="text" class="form-control" name="categories" id="email" value="emekaosuagwuandela@gmail.com" style="cursor: auto; background-image: url(&quot;data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGP6zwAAAgcBApocMXEAAAAASUVORK5CYII=&quot;);">
			</div>

			<div class="well">
				<label for="username">Video Description</label>
				<input type="text" class="form-control" name="description" id="username" value="emeka" style="cursor: auto; background-image: url(&quot;data:image/png;base64,&quot;); background-attachment: scroll; background-position: 100% 50%; background-repeat: no-repeat;">
			</div>
