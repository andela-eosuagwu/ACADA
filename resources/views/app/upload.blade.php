...
<div class="container user">
		...
		<form method="post" action="/video/create" id="update_profile_form">
			...
			<div class="well">
				...
				<input type="text" class="form-control" name="categories" id="email" style="cursor: auto; background-image: url(&quot;data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGP6zwAAAgcBApocMXEAAAAASUVORK5CYII=&quot;);">
			</div>
